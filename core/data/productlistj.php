...
#				) as attributes ON attributes.virtuemart_product_id = a.virtuemart_product_id
	...
	public function getProductList($parent, $remote_category) {
		...
		//********************************************************************
		//Convert the Virturmart Product List into a Cart-Product Harmonized List
		//********************************************************************
		...
		foreach ($this->products as $index => $prod) {
			...
			//Attributes
			$db->setQuery('
					SELECT custom_fields.virtuemart_customfield_id, custom_fields.virtuemart_product_id, custom_fields.customfield_value as value, field_details.custom_title as name
					FROM #__virtuemart_product_customfields custom_fields
					LEFT JOIN #__virtuemart_customs as field_details ON field_details.virtuemart_custom_id = custom_fields.virtuemart_custom_id
			');
